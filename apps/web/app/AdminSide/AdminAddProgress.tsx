...
export default function AdminAddProgress() {
    ...
    <main className="flex-1 p-6 md:p-10 font-['Inter'] flex justify-center items-start">
      <div className="w-full max-w-4xl bg-white border-2 border-[#bd00ff] rounded-2xl p-6 md:p-10 flex flex-col gap-8 shadow-sm">
        ...
        <div className="flex items-center gap-4 border-b border-gray-100 pb-4">
          <button onClick={() => navigate('/admin/monitoring')} className="text-black hover:text-[#bd00ff] transition-colors bg-transparent border-none cursor-pointer">
            <ChevronLeft size={32} />
          </button>
